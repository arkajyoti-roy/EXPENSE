...
const ActionButton = ({ fetchData }) => {
  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 lg:gap-5 px-4 sm:px-6 lg:px-36 pt-4 sm:pt-6">
        ...
        <button onClick={openNewTransaction} className="flex cursor-pointer items-center justify-center sm:justify-start space-x-2 bg-emerald-500 text-white px-4 py-2.5 sm:py-2 rounded-lg hover:bg-emerald-600 transition-colors duration-200 w-full sm:w-auto">
        ...
        <button onClick={openNewRecurring} className="flex cursor-pointer items-center justify-center sm:justify-start space-x-2 bg-blue-500 text-white px-4 py-2.5 sm:py-2 rounded-lg hover:bg-blue-600 transition-colors duration-200 w-full sm:w-auto">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 flex-shrink-0" viewBox="0 0 24 24">
        ...
        <button onClick={openBudgetModal} className="flex cursor-pointer items-center justify-center sm:justify-start space-x-2 bg-purple-500 text-white px-4 py-2.5 sm:py-2 rounded-lg hover:bg-purple-600 transition-colors duration-200 w-full sm:w-auto">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 flex-shrink-0" viewBox="0 0 24 24">
  ...
  className="flex items-center cursor-pointer justify-center sm:justify-start space-x-2 bg-blue-500 text-white px-4 py-2.5 sm:py-2 rounded-lg hover:bg-blue-600 transition-colors duration-200 w-full sm:w-auto"
>
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 flex-shrink-0" viewBox="0 0 24 24">
    <path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/>
    <path d="M21 3v5h-5"/>
